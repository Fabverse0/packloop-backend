...
VALUES
    ('TOTE_BAG', 'Tote Bag Kain', 'ITEM', 50, 0.50), -- 50 poin per 1 tote bag, 0.5kg CO2 / item
    ('PAPER_BAG', 'Paper Bag Kertas', 'ITEM', 30, 0.30) -- 30 poin per 1 paper bag, 0.3kg CO2 / item
...
VALUES
    ('a1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'TOTE_BAG', 50.00, 150.00, 'AVAILABLE'),
    ('a2222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'PAPER_BAG', 30.00, 150.00, 'AVAILABLE'),
    ('b1111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'TOTE_BAG', 125.00, 150.00, 'ALMOST_FULL'),
    ('b2222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'PAPER_BAG', 20.00, 150.00, 'AVAILABLE')
ON CONFLICT (id) DO NOTHING;
